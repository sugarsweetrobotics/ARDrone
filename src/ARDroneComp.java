 ...
 *
 */
public class ARDroneComp implements ModuleInitProc {

    public void myModuleInit(Manager mgr) {
      Properties prop = new Properties(ARDrone.component_conf);
      mgr.registerFactory(prop, new ARDrone(), new ARDrone());

      // Create a component
      RTObject_impl comp = mgr.createComponent("ARDrone");
      if( comp==null ) {
...
//      }
    ...
    public static void main(String[] args) {
        ...
        ARDroneComp init = new ARDroneComp();
